        ...
        if ser.in_waiting > 0:
            ...
            while incoming_param.lower() != "exit":
                ...
                if len(pos_tags) == 1:
                    ...
                    elif (pos_tags[0][1] == "RB" or pos_tags[0][1] == "VB") and (
                            pos_tags[1][1] == "NN" or pos_tags[1][1] == "NNS"):
                    ...
                    elif pos_tags[0][1] == "VB" and (pos_tags[1][1] == "NN" or pos_tags[1][1] == "JJ") and pos_tags[2][
                        1] == "NN":
                    ...
                    if pos_tags[0][1] == "WP" and pos_tags[1][1] == "NN" and pos_tags[2][1] == "NN" and pos_tags[3][
                        1] == "VB":
                        final_output = pos_tags[0][0] + " " + pos_tags[1][0] + " does the " + pos_tags[2][0] + " " + \
                                       pos_tags[3][0]
